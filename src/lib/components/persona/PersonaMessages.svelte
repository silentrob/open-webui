<script lang="ts">
	...
	import UserMessage from '../chat/Messages/UserMessage.svelte';
	...
	import CompareMessages from '../chat/Messages/CompareMessages.svelte';
...
<div class="h-full flex">
	{#if messages.length == 0}
		<div
			class=" mt-2 mb-4 mx-4 text-3xl text-gray-800 dark:text-gray-100 font-semibold text-left flex items-center gap-4"
		>
			<div>
				...
				<div in:fade={{ duration: 200, delay: 200 }}>
					<div class=" font-medium text-gray-400 dark:text-gray-500 line-clamp-1">
						{$i18n.t('What adventures do you seek today?')}
				</div>
			</div>
		</div>
	</div>
